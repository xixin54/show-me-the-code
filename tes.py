...
## load data
srcfile = r"C:\Users\siege\Desktop\crd3.txt" if platform.system() == "Windows" else "/home/zkpk/Desktop/wfsiege/clnt_merch_count.txt"
fp = open(srcfile, "r")
users = {}
# txndt = {}
...
def recommendByUserFC(filename: object, userId: object, k: object = 3) -> object:
    ...
    neighbors = getNearestNeighbor(userId, userDict, itemUser)[:5]  # 找邻居
    print(neighbors)
...
recommend_list, user_items, itemUser, neighbors = recommendByUserFC(srcfile, 100000004, 5)
